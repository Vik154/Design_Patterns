...
# Посредник – это поведенческий паттерн, который упрощает коммуникацию между 
# компонентами системы. Посредник убирает прямые связи между отдельными компонентами,
#  заставляя их общаться друг с другом через себя.
# https://github.com/ivashkevichdn/PatternsTutorial/blob/master/Behavioral/Python/mediator.py
...
# компонентов. Они также не зависят от каких-либо конкретных классо посредников.
